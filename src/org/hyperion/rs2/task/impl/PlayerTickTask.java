...
public class PlayerTickTask implements Task {
	...
	public void execute(GameEngine context) {
		/*
		 * We decrease our combat delay.
		 */
		player.decreaseCombatDelay(600);
		/*
		 * We update our barrows state.
		 */
		player.updateBarrowsState();
		/*
		 * We update our wilderness state.
		 */
		player.updateWildernessState();
		/*
		 * We handle our next chatmessage using our chat message queue.
		 */
