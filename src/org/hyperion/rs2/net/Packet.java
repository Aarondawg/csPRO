...
public class Packet {
	 ...
	 */
	public int getLEInt() {
		return (payload.get() & 0xff) | ((payload.get() & 0xff) << 8)
				| ((payload.get() & 0xff) << 16)
				| ((payload.get() & 0xff) << 24);
	}
	 ...
	 */
	public int getInt1() {
		return ((payload.get() & 0xff) << 8) | (payload.get() & 0xff)
				| ((payload.get() & 0xff) << 24)
				| ((payload.get() & 0xff) << 16);
	}
	 ...
	 */
	public int getInt2() {
		return ((payload.get() & 0xff) << 16) | ((payload.get() & 0xff) << 24)
				| (payload.get() & 0xff) | ((payload.get() & 0xff) << 8);
	}
